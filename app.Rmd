...
renderPlot({
  ...
  ggplot(line,aes(x=horas,y=n))+geom_line()+
    scale_x_continuous("horas", labels = as.character(line$horas), breaks = line$horas)+
    labs(y="Frequência")
  })    
...
-----------------------------------------------------------------------
```{r}
selectInput("ano4","ano",choices =unique(tentativa$ano))
